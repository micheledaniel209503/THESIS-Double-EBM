...
void VHB_test_SPEEDGOAT_step(void)
{
  ...
  if (tmp) {
    ...
    /* ToAsyncQueueBlock generated from: '<S1>/Analog input ' */
    slrtLogSignal
      (VHB_test_SPEEDGOAT_DW.TAQSigLogging_InsertedFor_Analo.SLRTSigHandles,
  ...
  if (tmp) {
    /* ToAsyncQueueBlock generated from: '<S2>/Transfer Fcn2' */
    slrtLogSignal
      (VHB_test_SPEEDGOAT_DW.TAQSigLogging_InsertedFor_Trans.SLRTSigHandles,
       VHB_test_SPEEDGOAT_M->Timing.t[1]);

    /* ToAsyncQueueBlock generated from: '<S3>/potent gain' */
    slrtLogSignal
...
void VHB_test_SPEEDGOAT_initialize(void)
{
  ...
  /* Start for ToAsyncQueueBlock generated from: '<S1>/Analog input ' */
  VHB_test_SPEEDGOAT_DW.TAQSigLogging_InsertedFor_Analo.SLRTSigHandles =
    slrtRegisterSignalToLoggingService(reinterpret_cast<uintptr_t>
    (&VHB_test_SPEEDGOAT_B.Laser));

  /* Start for ToAsyncQueueBlock generated from: '<S2>/Transfer Fcn2' */
  VHB_test_SPEEDGOAT_DW.TAQSigLogging_InsertedFor_Trans.SLRTSigHandles =
    slrtRegisterSignalToLoggingService(reinterpret_cast<uintptr_t>
    (&VHB_test_SPEEDGOAT_B.Loadcell));

  /* Start for ToAsyncQueueBlock generated from: '<S3>/potent gain' */
  VHB_test_SPEEDGOAT_DW.TAQSigLogging_InsertedFor_poten.SLRTSigHandles =
    slrtRegisterSignalToLoggingService(reinterpret_cast<uintptr_t>
    (&VHB_test_SPEEDGOAT_B.Pott_mm));
