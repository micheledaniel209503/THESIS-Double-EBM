#ifndef VHB_test_SPEEDGOAT_cal_h_
#define VHB_test_SPEEDGOAT_cal_h_
#include "rtwtypes.h"

/* Storage class 'PageSwitching', for system '<Root>' */
struct VHB_test_SPEEDGOAT_cal_type {
...
extern VHB_test_SPEEDGOAT_cal_type *VHB_test_SPEEDGOAT_cal;

#endif                                 /* VHB_test_SPEEDGOAT_cal_h_ */
