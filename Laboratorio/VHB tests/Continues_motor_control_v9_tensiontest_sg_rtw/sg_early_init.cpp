...
void sg_init_sfcns(void)
{
    ...
    rtssSetErrorStatusPtr(&sgEarlyInitSfcnInfo, (&rtmGetErrorStatus(Continues_motor_control_v9_tensiontest_M)));
    ...
    {
        SimStruct *rts = &Continues_motor_control_v9_tensiontest_M->NonInlinedSFcns.childSFunctions[0];
    ...
    {
        SimStruct *rts = &Continues_motor_control_v9_tensiontest_M->NonInlinedSFcns.childSFunctions[1];
        rts->blkInfo.blkInfo2 = (struct _ssBlkInfo2*)sg_early_init_get_blkInfo2();
        mxArray **sfcnParams = (mxArray **)
    ...
    {
        SimStruct *rts = &Continues_motor_control_v9_tensiontest_M->NonInlinedSFcns.childSFunctions[2];
        rts->blkInfo.blkInfo2 = (struct _ssBlkInfo2*)sg_early_init_get_blkInfo2();
        mxArray **sfcnParams = (mxArray **)
