...
%% INTERPOLATE THE MAXIMA AND THE MINIMA

%% FORCE - data processing
% the weight of the EBM + wire + plastic connector should be removed from
% the loadcell readings
loadcell_offset_V = -0.32; % [V] voltage corresponding to the weight of EBM + wire + plastic connector (pin)
loadcell_offset_V = 0;
...
max_stroke_V4 = max(stroke_V4);
max_stroke_V5 = max(stroke_V5);
max_stroke_V6 = max(stroke_V6);
